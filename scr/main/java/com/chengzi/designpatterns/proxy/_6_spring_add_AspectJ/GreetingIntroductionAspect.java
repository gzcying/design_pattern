...
import com.chengzi.designpatterns.proxy._4_springAOP.classAdvice.Apology;
...
public class GreetingIntroductionAspect {
    ...
    @DeclareParents(value = "com.chengzi.designpatterns.proxy._6_spring_add_AspectJ.GreetingIntroductionImpl", defaultImpl = ApologyImpl.class)
